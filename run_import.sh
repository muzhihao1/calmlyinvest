...
if echo "$RESPONSE" | grep -q '"success":true'; then
  ...
  echo "   📊 Stocks added: $STOCKS_ADDED"
  echo "   📈 Options added: $OPTIONS_ADDED"
else
  echo "❌ Import failed!"
